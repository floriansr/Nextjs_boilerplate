...
const defaultDescription = 'Boilerplate : NextJS StyledComponents Redux_Wrapper TypeScript';
const defaultOGURL = '';
...
AppHead.defaultProps = {
  title: process.env.NEXT_STATIC_APP_NAME || 'SSR styled-components with Next.js Starter',
